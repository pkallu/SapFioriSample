...
extension DetailViewController {
    ...
    func generatedTableDelegate() -> DetailTableDelegate? {
        ...
        case .packages:
            return PackagesTypeDetailTableDelegate(dataAccess: self.deliveryService, rightBarButton: self.navigationItem.rightBarButtonItem!)
        case .deliveryStatus:
            return DeliveryStatusTypeDetailTableDelegate(dataAccess: self.deliveryService, rightBarButton: self.navigationItem.rightBarButtonItem!)
        default:
            return nil
        }
    }
